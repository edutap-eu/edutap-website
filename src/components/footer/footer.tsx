        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="font-bold">
              A project initiated by EUGLOH and co-funded by LMU.
            </p>
            <div className="flex flex-row gap-4">
              <img
                src="/eugloh-white.webp"
                alt="EUGLOH"
                className="w-24 flex-1 object-contain"
              />
              <img
                src="/lmu-logo.png"
                alt="LMU"
                className="w-56 -m-2 flex-1 object-contain"
              />
            </div>
          ...
          <NavColumn
            ...
            links={[
              { href: "https://docs.edutap.eu/", label: "Documentation" },
              {
                ...
                label: "GitHub Repository / eduTAP-eu",
              },
              {
                href: "https://github.com/edutap-collective",
                label: "GitHub Repository / eduTAP-collective",
              },
            ]}
          />
