  ...
  <div className="bg-gradient-to-b from-secondary/50 py-16 md:py-36">
    ...
    >
      ...
      <p className="text-center text-xl text-gray-700 max-w-lg mb-12">
        Our Mission is to provide an interoperable solution that works for
        everyone.
      </p>
      ...
      <div className="space-y-16 max-w-2xl">
        <div className="flex flex-col md:flex-row md:items-center">
          ...
          <div>
            <h3 className="text-2xl font-bold tracking-tight mb-2">
              Digital First. Campus Ready.
            </h3>
            <p className="text-gray-600 text-lg">
              We are developing the digital campus card of the future for the
              smartphone.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg">
              eduTAP is your educational ID and a collection of service passes
      ...
      <ul className="max-w-2xl grid grid-cols-1 md:grid-cols-[auto_1fr] gap-4">
        {[
          ...
          <li key={index} className="flex items-center max-w-sm">
            <div className="w-8 h-8 flex-shrink-0 rounded-full bg-primary flex items-center justify-center mr-3 mt-0.5">
